...
define "security" do
  ...
  define "api" do
    compile.with AXIOM, CAS_CLIENT, DOM4J, CASTOR, LOG4J, SLF4J[:api], SLF4J[:log4j12], SLF4J[:jcl104overslf4j], SPRING[:core], XERCES[:impl], XERCES[:parserapi], OPENSSO_CLIENT_SDK, SERVLET_API,JASYPT, HIBERNATE_3_X
