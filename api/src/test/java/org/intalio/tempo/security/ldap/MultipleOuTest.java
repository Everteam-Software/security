...
public class MultipleOuTest {
	...
	public void loginToLdap() throws Exception {
		String pathToLdap = this.getClass()
				.getResource("/ldap_test.properties").getFile();
		...
		Property pwd = new Property(AuthenticationConstants.PROPERTY_PASSWORD,
				password);
	...
	public void testStandardOu() throws Exception {
		Assert.assertFalse(loginAndCollectRoles("admin@intalio.org", 2));
	}

	private boolean loginAndCollectRoles(String userId, int rolesInd)
			throws Exception {
